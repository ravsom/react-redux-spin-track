			...
			<div className="container">
				...
				<div className="panel panel-default">
					...
					<div className="panel-body">
						<b>Learn how to implement it by going through: <a
							href="https://medium.com/@rajaraodv/adding-a-robust-form-validation-to-react-redux-apps-616ca240c124"
							target="_blank">Adding A Robust Form Validation To React Redux Apps</a></b>
						<br/>
						<br/>
						<div className="alert alert-warning">
							NOTE: The app now has JWT Authentication turned on. <b>Please *Sign up* using some dummy data and *Sign
							in* to create new posts</b>
						</div>
					</div>
				</div>
