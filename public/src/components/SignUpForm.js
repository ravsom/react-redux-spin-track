...
class SignUpForm extends Component {
	...
	render() {
		const {asyncValidating, fields: { name, username, email, password, confirmPassword }, dispatch, handleSubmit, submitting } = this.props;
		return (
			<div className="container">
				<button className="btn btn-large btn-primary" onClick={this.props.facebookSignin.bind(this, dispatch)}>
					Facebook Login
				</button>
