...
//Sign Up User
export const FACEBOOK_SIGNIN_USER = 'FACEBOOK_SIGNIN_USER';
...
export function facebookSignin() {
	...
	const request = axios.get(`${ROOT_URL}/auth/facebook`).then(()=> {
		console.log("Fetch value from auth facebook");
	});

	return {
		type: FACEBOOK_SIGNIN_USER,
		payload: request
	};

}

export function facebookSigninSuccess(user) {
	console.log("facebook sign in success: " + user);
}

export function signUpUser(formValues) {

	console.log("Sign up user : " + formValues);
