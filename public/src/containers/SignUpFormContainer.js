...
import {facebookSignin, facebookSigninSuccess, signUpUser, signUpUserSuccess, signUpUserFailure, resetUser } from '../actions/users';
...
const asyncValidate = (values, dispatch) => {
	...
	console.log("Whose calling asyncValidate in the SignUpFormContainer");
...
const facebookSigninDispatch = (dispatch)=> {
	console.log("Type of dispatch: " + typeof dispatch);
	new Promise((resolve, reject)=> {
		dispatch(facebookSignin()).then((response)=> {
			console.log("log consoling: " + response);
		});
	})
};
...
const mapDispatchToProps = (dispatch) => {
	return {
		facebookSignin: facebookSigninDispatch,
